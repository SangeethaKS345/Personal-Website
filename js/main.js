...
const projectData = [
  {
    ...
    thumbnail: "./img/thumbnails/tesla-thumbnail.webp",
    description:
      "This is a clone of the canva website that I made to sharpen my HTML and CSS skills.",
    techStack: ["HTML", "CSS"],
    srcURL: "https://github.com/SangeethaKS345/Tesla-Clone/",
  },
  {
    title: "",
    subTitle:
      "A clone of the Zomato website.",
    thumbnail: "img\thumbnails\zomato-thumbnail.webp",
    description:
    ...
    techStack: ["HTML", "CSS"],
    srcURL: "https://github.com/SangeethaKS345/Zomato",
  },
  {
    title: "Zomato",
    subTitle:
      "A clone of the Zomato website",
    thumbnail: "./img/thumbnails/zomato-thumbnail.webp",
    description:
    ...
    techStack: ["HTML", "CSS"],
    srcURL: "https://faheem-t.github.io/odin-landing-page/",
  },
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/SangeethaKS345" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
...
async function getRepoList() {
  try {
    const response = await fetch(
      "https://api.github.com/users/Faheem-T/repos"
    );
